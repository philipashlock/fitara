...
To implement the requirements of FITARA, combined with the need to update policy and guidance related to other modern IT practices, OMB is establishing this guidance. This guidance reflects input from a diverse group of stakeholders, including representatives from the Chief Information Officer (CIO), Chief Financial Officer (CFO), Chief Human Capital Officer (CHCO), Chief Acquisition Officer (CAO), Assistant Secretary for Management (ASAM), and Chief Operating Officer (COO) communities.
...
3.  Establish the “Common Baseline” for roles, responsibilities, and authorities of the agency CIO and the roles and responsibilities of other applicable Senior Agency Officials  in managing IT as a strategic resource;
4.  Clarify the agency CIO’s role with respect to program IT, mission IT, and other cases of IT resources included in organizations not primarily IT-oriented;
...
1.  “Information technology resources” includes all:
  ...
  - acquisitions or inter-agency agreements which include information technology and the services or equipment provided by such acquisitions or inter-agency agreements;
...
2.  This definition and this memorandum refer to the term “information technology,” which for the purposes of this definition and memorandum is defined as:
  ...
  - The term “information technology” does not include any equipment that is acquired by a contractor incidental to a contract which does not require its use. 

This definition is based on the definition of information technology found in the Clinger-Cohen Act of 1996 . Additional definitions used in the Common Baseline are available in _Attachment A_.
...
3. Each agency shall take the following actions to implement the Common Baseline:
  ...
  - *Submit to OMB for approval of plan.* Covered agencies shall submit this self-assessment and this plan to OMB’s Office of E-government & Information Technology (E-Gov) as well as to the agency’s relevant OMB Resource Management Office for review and approval no later than August 15, 2015. Please submit these by email to egov@omb.eop.gov with the subject line: “[Agency Abbreviation] FITARA Common Baseline Plan.”  OMB may request additional information from agencies before approving the plan.  Agencies shall post the “plan” portion of this document (not the “self-assessment”) on their public website at agency.gov/digitalstrategy no more than 30 days following OMB approval and thereafter keep the public document up to date with access to a history of previous versions.

  - *Support ongoing oversight of plan and Common Baseline.* Covered agencies shall follow OMB guidance from PortfolioStat sessions and other oversight activities regarding the ongoing implementation of the Common Baseline. Agencies shall notify OMB of any obstacles or incomplete implementation of the Common Baseline on an ongoing basis following the initial implementation deadline. 
...
1. Covered agencies shall continue to report required data to OMB as part of the quarterly Integrated Data Collection (IDC),  per current instructions . OMB will continue to update IDC instructions posted on the MAX Federal Community on a quarterly basis. 
